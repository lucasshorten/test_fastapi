...
DEFAULT_RULES = [
    ...
    {
        "id": "motcle-cardiopathie-ischemique",
    ...
    },
    {
        ...
        "description": (
            ...
            "relecteur au vu du contexte clinique."
        ),
        "commentaires": [],
    },
    {
...
def update_rule(data_dir: Path, rule_id: str, titre: str | None = None,
                 logique: str | None = None, description: str | None = None) -> dict:
